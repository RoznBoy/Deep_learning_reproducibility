...
def train(args):
    ...
    #### Pytorch lightning training
        ...
        results = {
            ...
            # 'feature_extractor_dims': args.feature_extractor_dims,
            # 'layers_for_hidden_representation': args.layers_for_hidden_representation,
        ...
        results_file = "./{0}_{1}_{2}_best_metrics.csv".format(args.model,args.dataset,args.feature_extractor_dims)
...
def parse_arguments(args=None):
	...
	parser.add_argument('--model', type=str, choices=["remove_SPN_wpfs", "remove_WPN_wpfs", 'mlp', 'wpfs', 'rf', 'fsnet', 'cae', 'dietnetworks'], default='wpfs')
...
if __name__ == "__main__":
	...
	if args.use_best_hyperparams:
		if args.model in ["remove_SPN_wpfs", "remove_WPN_wpfs", 'wpfs', 'fsnet', 'dietnetworks']:
			if args.dataset=='cll':
